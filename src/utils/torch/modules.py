...
# PyTorch“Conv2D”模块的数据相关初始化+权重归一化扩展
...
# class used to store two sets of parameters 用于存储两组参数的类
# 1. parameters that are the result of EMA (for evaluation) EMA结果的参数（用于评估）
